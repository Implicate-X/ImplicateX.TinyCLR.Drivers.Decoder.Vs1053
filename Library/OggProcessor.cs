...
{
	/// <summary>
	/// Represents a media preprocessor for OGG audio files.
	/// </summary>
	public sealed class OggProcessor : IMediaPreprocessor
	{
		...
		public bool CanProcess( string extension )
			=> extension != null && extension.ToLower() == ".ogg";
		...
		public MediaPayLoad Process( FileStream fs )
		{
			...
			fs.Position = 0;
			Debug.WriteLineIf( EnableVerboseTrace, "[OggProcessor] OGG stream prepared from beginning." );
